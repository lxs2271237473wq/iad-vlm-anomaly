...
A6_ROOT = Path("orbitad/results/a16_normal_only_component_soft_router_v1")
...
protocol = {
    ...
    "postprocessing":False, "architecture":"normal-only component-level continuous soft router pilot"
}
