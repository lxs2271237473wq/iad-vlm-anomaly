...
DETAIL_CSV = (
    ROOT /
    "a5_1_category_condition_metrics.csv"
)

CONDITION_CSV = (
    ROOT /
    "a5_1_condition_metrics.csv"
)

SUMMARY_CSV = (
    ROOT /
    "a5_1_method_summary.csv"
)

CATEGORY_CSV = (
    ROOT /
    "a5_1_category_shift_gains.csv"
)

THRESHOLD_JSON = (
    ROOT /
    "a5_1_validation_thresholds.json"
)
...
print()
print("=" * 115)
print("A5.1 ORTHOGONAL SCORING RESULTS")
print("=" * 115)
