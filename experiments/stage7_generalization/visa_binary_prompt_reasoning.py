...
def evaluate_category(args, model, preprocess, tokenizer, device, category, strategy, eval_mode):
    pred_csv = Path(args.patchcore_root) / "VisA" / category / "patchcore_image_predictions.csv"
    ...
    boxes = load_candidate_boxes(args.patchcore_root, category, args.top_k)
...
def main():
    ...
    parser.add_argument("--patchcore_root", type=str, default="results/stage7_generalization/visa_patchcore")
