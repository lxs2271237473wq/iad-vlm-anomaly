...
OUT=results/stage24_evidence/20260911_e
mkdir -p "$OUT"
...
/opt/conda/bin/python -u experiments/stage24_evidence/run_highres_ad2.py \
...
/opt/conda/bin/python -u experiments/stage24_evidence/evaluate_ad2_highres.py \
 --run results/stage24_evidence/20260910_a --high "$OUT/fixed_bank" --out "$OUT/evaluation"
